<template>
  <div class="lcpsPlay" style="width: 800px;height: 400px;">
  	<div id="g-video-box"></div>
  </div>
</template>
...
<script>
    ...
    function loadPlayer(){
        var url = 'rtmp://'+lcpsUrl+'/3001' ;
        var playerId = 'g-video-box' ;
        var width = '100%' ;
        var height = '100%';
            studioApp_embedPlayer(width, height,url,'allpreview',1, playerId);
